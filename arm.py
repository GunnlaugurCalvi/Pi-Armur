...
arduino = Serial('/dev/cu.usbmodem14111', 9600)
...
def detectAndDisplay(frame, fr):
    ...
    if(len(faces)!=0):
        ...
        cv2.putText(frame, repr('FRAME' + str(fr)) + ' ' + repr(RECT[0] + RECT[2]/2)+'  '+repr(RECT[1]+RECT[3]/2)+' '+repr(RECT[2]*RECT[3]), (RECT[0],RECT[1]+RECT[3]),  cv2.FONT_HERSHEY_SIMPLEX , 1, (0,0,255));
...
cascade = cv2.CascadeClassifier('data/lbpcascades/lbpcascade_frontalface_improved.xml')
